...
class ApiKeyProviderTest {
    ...
    fun isValidKey_returnsTrueForValidOpenWeatherMap_key1() {
        ...
        val isValid = apiKeyImpl.isValidKey(ForecastServiceSource.OPEN_WEATHER_MAP, validKey)
    ...
    fun isValidKey_returnsFalseForInvalidOpenWeatherMapKey() {
        ...
        val isValid = apiKeyImpl.isValidKey(ForecastServiceSource.OPEN_WEATHER_MAP, invalidKey)
    ...
    fun isValidKey_returnsTrueForValidTomorrowIoKey_key1() {
        ...
        val isValid = apiKeyImpl.isValidKey(ForecastServiceSource.TOMORROW_IO, validKey)
        assertThat(isValid).isTrue()
    }
    ...
    fun isValidKey_returnsFalseForInvalidTomorrowIoKey() {
        val invalidKey = "invalidKey"
        val isValid = apiKeyImpl.isValidKey(ForecastServiceSource.TOMORROW_IO, invalidKey)
        assertThat(isValid).isFalse()
    }
    ...
    fun hasUserProvidedApiKey_returnsTrueWhenUserProvidedKey() =
        runTest {
            preferencesManager.saveUserApiKey(ForecastServiceSource.OPEN_WEATHER_MAP, "userProvidedKey")

            val hasUserProvidedKey = apiKeyImpl.hasUserProvidedApiKey(ForecastServiceSource.OPEN_WEATHER_MAP)
    ...
    fun hasUserProvidedApiKey_returnsFalseWhenUsingDefaultKey() =
        runTest {
            preferencesManager.saveUserApiKey(ForecastServiceSource.OPEN_WEATHER_MAP, "")
