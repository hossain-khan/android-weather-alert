...
data class BringYourOwnApiKeyScreen(
     ...
     */
    val weatherApiService: ForecastServiceSource,
    /**
    ...
    data class State(
        val forecastServiceSource: ForecastServiceSource,
    ...
    constructor(
        ...
        override fun present(): BringYourOwnApiKeyScreen.State {
            ...
            return BringYourOwnApiKeyScreen.State(
                forecastServiceSource = screen.weatherApiService,
...
fun BringYourOwnApiKeyScreen(
    ...
    val serviceConfig: WeatherServiceConfig = state.forecastServiceSource.serviceConfig()
        ...
        BringYourOwnApiKeyScreen(
            state =
                BringYourOwnApiKeyScreen.State(
                    forecastServiceSource = ForecastServiceSource.OPEN_WEATHER_MAP,
